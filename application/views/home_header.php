...
<head lang="en">
    ...
    <link href="public/css/homeCss.css" type="text/css" rel="stylesheet">
 ...
 <div class="wrap_all">   
    <div class="contain">
        ...
        <nav class="navbar navbar-fixed-top" role="navigation">
	        <div class="row navbar-wrapper collapse navbar-collapse">        
		        <ul class="nav navbar-right navbar-nav">
								<li><span class="logined"><?php echo $_SESSION ['nickname'];?></span></li>
